...
insert into symptom(name) values ('Ói mửa');
...
insert into symptom(name) values ('Đau vùng vai và cánh tay trái');
insert into symptom(name) values ('Sưng chân, bàn chân');
...
insert into symptom(name) values ('Đau tai');
...
insert into symptom(name) values ('Đau đầu');
...
insert into symptom(name) values ('Đau cổ');
insert into symptom(name) values ('Đau họng');
...
insert into symptom(name) values ('Sự thay đổi cân nặng');
insert into symptom(name) values ('Tiểu đường');
...
insert into symptom(name) values ('Buồn nôn');
insert into symptom(name) values ('Đau bụng');
insert into symptom(name) values ('Táo bón');
insert into symptom(name) values ('Sưng bụng');
...
insert into symptom(name) values ('Béo phì');
insert into symptom(name) values ('Sự thay đổi giọng nói');
insert into symptom(name) values ('Sưng môi');
insert into symptom(name) values ('Sự cảm thấy mệt mỏi khi thực hiện hoạt động');
insert into symptom(name) values ('Viêm phế quản');
insert into symptom(name) values ('Ho ra máu');
insert into symptom(name) values ('Sưng mũi');
insert into symptom(name) values ('Cảm lạnh');
insert into symptom(name) values ('Tê liệt');
insert into symptom(name) values ('Mất trí nhớ');
insert into symptom(name) values ('Co giật');
insert into symptom(name) values ('Rối loạn giấc ngủ');
insert into symptom(name) values ('Rối loạn cảm xúc');
insert into symptom(name) values ('Tình trạng lo âu');
insert into symptom(name) values ('Mất thính lực');
insert into symptom(name) values ('Rát môi');
insert into symptom(name) values ('Cảm lạnh sống lưng');
insert into symptom(name) values ('Vong đuổi');
insert into symptom(name) values ('Mất trí nhớ trong thời gian ngắn');
insert into symptom(name) values ('Co giật toàn thân luôn');
insert into symptom(name) values ('Rối loạn tiêu chảy');
insert into symptom(name) values ('Rối loạn giác quan');
insert into symptom(name) values ('Tình trạng thiếu nước');
insert into symptom(name) values ('Mất thị lực một bên');
insert into symptom(name) values ('Mất cảm giác');
insert into symptom(name) values ('Đau mỏi vai gáy');
